...
router.get("/", function (req, res, next) {
  res.render("index", { title: "Department App", user: req.user });
});

router.get("/register", function (req, res) {
  res.render("register", { title: "Department App Registration" });
});
...
router.get("/login", function (req, res) {
  res.render("login", { title: "Department App Login", user: req.user });
});
